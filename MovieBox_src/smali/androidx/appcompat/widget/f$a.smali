...
# virtual methods
.method public a(Landroidx/appcompat/widget/e0;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    .locals 3
    ...
    invoke-virtual {p0, p1, p2, p3}, Landroidx/appcompat/widget/f$a;->l(Landroidx/appcompat/widget/e0;Landroid/content/Context;I)Landroid/graphics/drawable/LayerDrawable;
...
.method public b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, p2}, Ld1/a;->a(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, p2}, Landroidx/appcompat/widget/i0;->e(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
...
.method public c(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-static {p1, p2}, Landroidx/appcompat/widget/i0;->c(Landroid/content/Context;I)I
...
.method public e(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-static {p1, v0}, Landroidx/appcompat/widget/i0;->c(Landroid/content/Context;I)I
    ...
    invoke-static {p1, p3}, Landroidx/appcompat/widget/i0;->c(Landroid/content/Context;I)I
    ...
    invoke-static {p1, v0}, Landroidx/appcompat/widget/i0;->b(Landroid/content/Context;I)I
...
.method public final h(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v2}, Landroidx/appcompat/widget/i0;->c(Landroid/content/Context;I)I

    move-result v2

    sget v3, Landroidx/appcompat/R$attr;->colorButtonNormal:I

    invoke-static {p1, v3}, Landroidx/appcompat/widget/i0;->b(Landroid/content/Context;I)I

    move-result p1

    sget-object v3, Landroidx/appcompat/widget/i0;->b:[I
    ...
    sget-object p1, Landroidx/appcompat/widget/i0;->e:[I

    const/4 v3, 0x1

    aput-object p1, v1, v3

    invoke-static {v2, p2}, Lc3/b;->g(II)I

    move-result p1

    aput p1, v0, v3

    sget-object p1, Landroidx/appcompat/widget/i0;->c:[I
    ...
    sget-object p1, Landroidx/appcompat/widget/i0;->i:[I
...
.method public final k(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v2}, Landroidx/appcompat/widget/i0;->e(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    sget-object v6, Landroidx/appcompat/widget/i0;->b:[I
    ...
    sget-object v5, Landroidx/appcompat/widget/i0;->f:[I

    aput-object v5, v1, v4

    sget v5, Landroidx/appcompat/R$attr;->colorControlActivated:I

    invoke-static {p1, v5}, Landroidx/appcompat/widget/i0;->c(Landroid/content/Context;I)I
    ...
    :cond_0
    sget-object v2, Landroidx/appcompat/widget/i0;->b:[I

    aput-object v2, v1, v5

    sget v2, Landroidx/appcompat/R$attr;->colorSwitchThumbNormal:I

    invoke-static {p1, v2}, Landroidx/appcompat/widget/i0;->b(Landroid/content/Context;I)I

    move-result v2

    aput v2, v0, v5

    sget-object v2, Landroidx/appcompat/widget/i0;->f:[I
    ...
    sget-object v2, Landroidx/appcompat/widget/i0;->i:[I
...
.method public final l(Landroidx/appcompat/widget/e0;Landroid/content/Context;I)Landroid/graphics/drawable/LayerDrawable;
    .locals 4
    .param p1    # Landroidx/appcompat/widget/e0;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
