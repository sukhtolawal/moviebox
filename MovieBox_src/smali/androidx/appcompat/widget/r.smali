...
.field public final k:Landroidx/appcompat/widget/r$d;
...
.method public constructor <init>(Landroid/widget/TextView;)V
    ...
    new-instance p1, Landroidx/appcompat/widget/r$c;

    invoke-direct {p1}, Landroidx/appcompat/widget/r$c;-><init>()V

    iput-object p1, p0, Landroidx/appcompat/widget/r;->k:Landroidx/appcompat/widget/r$d;
    ...
    new-instance p1, Landroidx/appcompat/widget/r$b;

    invoke-direct {p1}, Landroidx/appcompat/widget/r$b;-><init>()V
...
.method public static m(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :try_start_0
    invoke-static {p1}, Landroidx/appcompat/widget/r;->k(Ljava/lang/String;)Ljava/lang/reflect/Method;
...
.method public a()V
    ...
    :cond_1
    iget-object v0, p0, Landroidx/appcompat/widget/r;->k:Landroidx/appcompat/widget/r$d;

    iget-object v1, p0, Landroidx/appcompat/widget/r;->i:Landroid/widget/TextView;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/r$d;->b(Landroid/widget/TextView;)Z
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/r;->i:Landroid/widget/TextView;
    ...
    :cond_3
    sget-object v2, Landroidx/appcompat/widget/r;->l:Landroid/graphics/RectF;
    ...
    invoke-virtual {p0, v2}, Landroidx/appcompat/widget/r;->e(Landroid/graphics/RectF;)I
    ...
    invoke-virtual {p0, v1, v0}, Landroidx/appcompat/widget/r;->t(IF)V
...
.method public d(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;II)Landroid/text/StaticLayout;
    ...
    iget-object v6, p0, Landroidx/appcompat/widget/r;->i:Landroid/widget/TextView;

    iget-object v7, p0, Landroidx/appcompat/widget/r;->h:Landroid/text/TextPaint;

    iget-object v8, p0, Landroidx/appcompat/widget/r;->k:Landroidx/appcompat/widget/r$d;
    ...
    invoke-static/range {v2 .. v8}, Landroidx/appcompat/widget/r$a;->a(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;IILandroid/widget/TextView;Landroid/text/TextPaint;Landroidx/appcompat/widget/r$d;)Landroid/text/StaticLayout;
    ...
    :cond_0
    iget-object p4, p0, Landroidx/appcompat/widget/r;->i:Landroid/widget/TextView;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/r;->h:Landroid/text/TextPaint;
...
.method public final e(Landroid/graphics/RectF;)I
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/r;->f:[I

    aget v3, v3, v2

    invoke-virtual {p0, v3, p1}, Landroidx/appcompat/widget/r;->x(ILandroid/graphics/RectF;)Z
    ...
    :cond_1
    iget-object p1, p0, Landroidx/appcompat/widget/r;->f:[I
...
.method public g()I
    ...
    iget v0, p0, Landroidx/appcompat/widget/r;->d:F
...
.method public h()I
    ...
    iget v0, p0, Landroidx/appcompat/widget/r;->c:F
...
.method public l(I)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/r;->h:Landroid/text/TextPaint;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/r;->h:Landroid/text/TextPaint;
...
.method public o(Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {p0, v4}, Landroidx/appcompat/widget/r;->v(Landroid/content/res/TypedArray;)V
    ...
    :cond_7
    invoke-virtual {p0, v1, v3, p1}, Landroidx/appcompat/widget/r;->z(FFF)V

    :cond_8
    invoke-virtual {p0}, Landroidx/appcompat/widget/r;->u()Z
...
.method public p(IIII)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Landroidx/appcompat/widget/r;->z(FFF)V
...
.method public q([II)V
    ...
    :cond_0
    iget-object v3, p0, Landroidx/appcompat/widget/r;->j:Landroid/content/Context;
    ...
    :cond_1
    :goto_1
    invoke-virtual {p0, v2}, Landroidx/appcompat/widget/r;->b([I)[I

    move-result-object p2

    iput-object p2, p0, Landroidx/appcompat/widget/r;->f:[I
    ...
    :cond_3
    iput-boolean v1, p0, Landroidx/appcompat/widget/r;->g:Z
...
.method public r(I)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/r;->j:Landroid/content/Context;
    ...
    invoke-virtual {p0, v0, p1, v1}, Landroidx/appcompat/widget/r;->z(FFF)V
...
.method public final s(F)V
    ...
    invoke-static {v1}, Landroidx/appcompat/widget/r;->k(Ljava/lang/String;)Ljava/lang/reflect/Method;
...
.method public t(IF)V
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/r;->s(F)V
...
.method public final v(Landroid/content/res/TypedArray;)V
    ...
    :cond_0
    invoke-virtual {p0, v1}, Landroidx/appcompat/widget/r;->b([I)[I

    move-result-object p1

    iput-object p1, p0, Landroidx/appcompat/widget/r;->f:[I
...
.method public final x(ILandroid/graphics/RectF;)Z
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/r;->l(I)V
    ...
    invoke-static {p1, v2, v3}, Landroidx/appcompat/widget/r;->m(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v0, p1, v2, v1}, Landroidx/appcompat/widget/r;->d(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;II)Landroid/text/StaticLayout;
