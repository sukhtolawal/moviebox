...
.method public constructor <init>(Landroidx/appcompat/widget/AppCompatSpinner;Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/AppCompatSpinner$f;->O:Landroidx/appcompat/widget/AppCompatSpinner;
    ...
    iput-object p2, p0, Landroidx/appcompat/widget/AppCompatSpinner$f;->M:Landroid/graphics/Rect;
...
.method public S()V
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/AppCompatSpinner$f;->O:Landroidx/appcompat/widget/AppCompatSpinner;

    iget-object v1, v1, Landroidx/appcompat/widget/AppCompatSpinner;->i:Landroid/graphics/Rect;

    invoke-virtual {v0, v1}, Landroid/graphics/drawable/Drawable;->getPadding(Landroid/graphics/Rect;)Z

    iget-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner$f;->O:Landroidx/appcompat/widget/AppCompatSpinner;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/AppCompatSpinner$f;->O:Landroidx/appcompat/widget/AppCompatSpinner;

    invoke-virtual {v2}, Landroid/view/View;->getPaddingRight()I

    move-result v2

    iget-object v3, p0, Landroidx/appcompat/widget/AppCompatSpinner$f;->O:Landroidx/appcompat/widget/AppCompatSpinner;

    invoke-virtual {v3}, Landroid/view/View;->getWidth()I

    move-result v3

    iget-object v4, p0, Landroidx/appcompat/widget/AppCompatSpinner$f;->O:Landroidx/appcompat/widget/AppCompatSpinner;
    ...
    iget-object v5, p0, Landroidx/appcompat/widget/AppCompatSpinner$f;->L:Landroid/widget/ListAdapter;
    ...
    iget-object v5, p0, Landroidx/appcompat/widget/AppCompatSpinner$f;->O:Landroidx/appcompat/widget/AppCompatSpinner;
    ...
    iget-object v6, p0, Landroidx/appcompat/widget/AppCompatSpinner$f;->O:Landroidx/appcompat/widget/AppCompatSpinner;
...
.method public T()I
    ...
    iget v0, p0, Landroidx/appcompat/widget/AppCompatSpinner$f;->N:I
...
.method public U(Landroid/view/View;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner$f;->M:Landroid/graphics/Rect;
...
.method public f()Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner$f;->K:Ljava/lang/CharSequence;
...
.method public h(Ljava/lang/CharSequence;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/AppCompatSpinner$f;->K:Ljava/lang/CharSequence;
...
.method public j(I)V
    ...
    iput p1, p0, Landroidx/appcompat/widget/AppCompatSpinner$f;->N:I
...
.method public k(II)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/AppCompatSpinner$f;->O:Landroidx/appcompat/widget/AppCompatSpinner;
...
.method public m(Landroid/widget/ListAdapter;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/AppCompatSpinner$f;->L:Landroid/widget/ListAdapter;
