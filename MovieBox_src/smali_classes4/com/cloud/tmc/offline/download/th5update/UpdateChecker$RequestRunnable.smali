...
# direct methods
.method public constructor <init>(Lcom/cloud/tmc/offline/download/th5update/UpdateChecker;Ljava/lang/String;Ljava/util/Map;Ljava/util/Map;Lm9/c;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p5, p0, Lcom/cloud/tmc/offline/download/th5update/UpdateChecker$RequestRunnable;->updateManager:Lm9/c;

    return-void
.end method

.method public synthetic constructor <init>(Lcom/cloud/tmc/offline/download/th5update/UpdateChecker;Ljava/lang/String;Ljava/util/Map;Ljava/util/Map;Lm9/c;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    .locals 6
    ...
    .line 2
    invoke-direct/range {v0 .. v5}, Lcom/cloud/tmc/offline/download/th5update/UpdateChecker$RequestRunnable;-><init>(Lcom/cloud/tmc/offline/download/th5update/UpdateChecker;Ljava/lang/String;Ljava/util/Map;Ljava/util/Map;Lm9/c;)V
...
.method public final getUpdateManager()Lm9/c;
    ...
    .line 1
    iget-object v0, p0, Lcom/cloud/tmc/offline/download/th5update/UpdateChecker$RequestRunnable;->updateManager:Lm9/c;
...
.method public run()V
    ...
    .line 15
    new-instance v4, Lcom/cloud/tmc/offline/download/th5update/UpdateChecker$RequestRunnable$a;

    .line 17
    invoke-direct {v4, p0}, Lcom/cloud/tmc/offline/download/th5update/UpdateChecker$RequestRunnable$a;-><init>(Lcom/cloud/tmc/offline/download/th5update/UpdateChecker$RequestRunnable;)V
    ...
    .line 29
    iget-object v3, p0, Lcom/cloud/tmc/offline/download/th5update/UpdateChecker$RequestRunnable;->updateManager:Lm9/c;

    .line 31
    invoke-static {v1, v2, v3, v0}, Lcom/cloud/tmc/offline/download/th5update/UpdateChecker;->c(Lcom/cloud/tmc/offline/download/th5update/UpdateChecker;Ljava/lang/String;Lm9/c;Ljava/lang/Exception;)V
