...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/cloud/tmc/integration/bridge/SystemAbilityBridge;->preloadResources(Lcom/cloud/tmc/integration/structure/App;Lcom/google/gson/JsonArray;Lbc/a;)V
.end annotation
...
.method public final invoke()V
    ...
    iget-object v6, v0, Lcom/cloud/tmc/integration/bridge/SystemAbilityBridge$preloadResources$4$block$1;->$downloadFile:Ljava/io/File;
    ...
    new-instance v7, Lcom/cloud/tmc/integration/bridge/SystemAbilityBridge$preloadResources$4$block$1$1;

    iget-object v9, v0, Lcom/cloud/tmc/integration/bridge/SystemAbilityBridge$preloadResources$4$block$1;->$app:Lcom/cloud/tmc/integration/structure/App;

    iget-object v10, v0, Lcom/cloud/tmc/integration/bridge/SystemAbilityBridge$preloadResources$4$block$1;->$downloadFile:Ljava/io/File;

    iget-object v11, v0, Lcom/cloud/tmc/integration/bridge/SystemAbilityBridge$preloadResources$4$block$1;->$filePath:Ljava/lang/String;

    iget-object v12, v0, Lcom/cloud/tmc/integration/bridge/SystemAbilityBridge$preloadResources$4$block$1;->$ret:Ljava/util/List;

    iget-object v13, v0, Lcom/cloud/tmc/integration/bridge/SystemAbilityBridge$preloadResources$4$block$1;->$appId:Ljava/lang/String;

    iget-object v14, v0, Lcom/cloud/tmc/integration/bridge/SystemAbilityBridge$preloadResources$4$block$1;->$src:Ljava/lang/String;

    iget-object v15, v0, Lcom/cloud/tmc/integration/bridge/SystemAbilityBridge$preloadResources$4$block$1;->$countDownLatch:Ljava/util/concurrent/CountDownLatch;

    iget-object v8, v0, Lcom/cloud/tmc/integration/bridge/SystemAbilityBridge$preloadResources$4$block$1;->$downloadSuccess:Ljava/util/Set;

    move-object/from16 v16, v8

    move-object v8, v7

    invoke-direct/range {v8 .. v16}, Lcom/cloud/tmc/integration/bridge/SystemAbilityBridge$preloadResources$4$block$1$1;-><init>(Lcom/cloud/tmc/integration/structure/App;Ljava/io/File;Ljava/lang/String;Ljava/util/List;Ljava/lang/String;Ljava/lang/String;Ljava/util/concurrent/CountDownLatch;Ljava/util/Set;)V

    new-instance v8, Lcom/cloud/tmc/integration/bridge/SystemAbilityBridge$preloadResources$4$block$1$2;

    iget-object v9, v0, Lcom/cloud/tmc/integration/bridge/SystemAbilityBridge$preloadResources$4$block$1;->$countDownLatch:Ljava/util/concurrent/CountDownLatch;

    iget-object v10, v0, Lcom/cloud/tmc/integration/bridge/SystemAbilityBridge$preloadResources$4$block$1;->$downloadFailed:Ljava/util/Set;

    invoke-direct {v8, v9, v10}, Lcom/cloud/tmc/integration/bridge/SystemAbilityBridge$preloadResources$4$block$1$2;-><init>(Ljava/util/concurrent/CountDownLatch;Ljava/util/Set;)V
