...
# direct methods
.method public constructor <init>(Lw30/c;ILio/reactivex/rxjava3/internal/queue/SpscArrayQueue;Lio/reactivex/rxjava3/core/Scheduler$Worker;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/rxjava3/internal/operators/parallel/ParallelRunOn$RunOnSubscriber;->downstream:Lw30/c;
...
.method public onSubscribe(Lw30/d;)V
    ...
    iget-object v0, p0, Lio/reactivex/rxjava3/internal/operators/parallel/ParallelRunOn$RunOnSubscriber;->downstream:Lw30/c;
...
.method public run()V
    ...
    iget-object v3, v0, Lio/reactivex/rxjava3/internal/operators/parallel/ParallelRunOn$RunOnSubscriber;->downstream:Lw30/c;
    ...
    invoke-interface {v3, v15}, Lw30/c;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-interface {v3}, Lw30/c;->onComplete()V
    ...
    :cond_6
    invoke-interface {v3, v15}, Lw30/c;->onNext(Ljava/lang/Object;)V
    ...
    iget-object v13, v0, Lio/reactivex/rxjava3/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->upstream:Lw30/d;

    int-to-long v14, v1

    invoke-interface {v13, v14, v15}, Lw30/d;->request(J)V
    ...
    invoke-interface {v3, v13}, Lw30/c;->onError(Ljava/lang/Throwable;)V
