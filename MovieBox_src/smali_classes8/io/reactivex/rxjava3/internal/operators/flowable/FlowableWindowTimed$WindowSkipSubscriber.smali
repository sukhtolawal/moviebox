...
.method public constructor <init>(Lw30/c;JJLjava/util/concurrent/TimeUnit;Lio/reactivex/rxjava3/core/Scheduler$Worker;I)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public createFirstWindow()V
    ...
    new-instance v1, Lio/reactivex/rxjava3/internal/operators/flowable/g;

    invoke-direct {v1, v0}, Lio/reactivex/rxjava3/internal/operators/flowable/g;-><init>(Lio/reactivex/rxjava3/processors/a;)V
    ...
    invoke-interface {v2, v1}, Lw30/c;->onNext(Ljava/lang/Object;)V
    ...
    invoke-virtual {v2, v3, v5, v6, v7}, Lio/reactivex/rxjava3/core/Scheduler$Worker;->schedule(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lj10/b;
    ...
    invoke-virtual/range {v8 .. v14}, Lio/reactivex/rxjava3/core/Scheduler$Worker;->schedulePeriodically(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lj10/b;

    invoke-virtual {v1}, Lio/reactivex/rxjava3/internal/operators/flowable/g;->h()Z
...
.method public drain()V
    ...
    invoke-interface {v1, v6}, Lw30/c;->onNext(Ljava/lang/Object;)V
    ...
    invoke-virtual {v8, v9, v10, v11, v7}, Lio/reactivex/rxjava3/core/Scheduler$Worker;->schedule(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lj10/b;
    ...
    :cond_8
    iget-object v7, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableWindowTimed$AbstractWindowSubscriber;->upstream:Lw30/d;

    invoke-interface {v7}, Lw30/d;->cancel()V

    new-instance v7, Lio/reactivex/rxjava3/exceptions/MissingBackpressureException;

    invoke-static {v5, v6}, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableWindowTimed;->h(J)Ljava/lang/String;
    ...
    :cond_9
    invoke-interface {v1, v7}, Lw30/c;->onError(Ljava/lang/Throwable;)V
