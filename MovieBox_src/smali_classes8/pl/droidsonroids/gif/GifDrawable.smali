...
.field public final o:Lpl/droidsonroids/gif/RenderTask;
...
.method public constructor <init>(Landroid/content/res/Resources;I)V
    ...
    invoke-static {p1, p2}, Lpl/droidsonroids/gif/d;->b(Landroid/content/res/Resources;I)F

    move-result p1

    iget-object p2, p0, Lpl/droidsonroids/gif/GifDrawable;->h:Lpl/droidsonroids/gif/GifInfoHandle;
    ...
    iput p2, p0, Lpl/droidsonroids/gif/GifDrawable;->s:I
...
.method public constructor <init>(Lpl/droidsonroids/gif/GifInfoHandle;Lpl/droidsonroids/gif/GifDrawable;Ljava/util/concurrent/ScheduledThreadPoolExecutor;Z)V
    ...
    iput-object v1, p0, Lpl/droidsonroids/gif/GifDrawable;->f:Landroid/graphics/Paint;

    new-instance v1, Ljava/util/concurrent/ConcurrentLinkedQueue;

    invoke-direct {v1}, Ljava/util/concurrent/ConcurrentLinkedQueue;-><init>()V

    iput-object v1, p0, Lpl/droidsonroids/gif/GifDrawable;->i:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    iput-object v1, p0, Lpl/droidsonroids/gif/GifDrawable;->o:Lpl/droidsonroids/gif/RenderTask;

    iput-boolean p4, p0, Lpl/droidsonroids/gif/GifDrawable;->m:Z
    ...
    iput-object p1, p0, Lpl/droidsonroids/gif/GifDrawable;->h:Lpl/droidsonroids/gif/GifInfoHandle;
    ...
    iget-object v2, p2, Lpl/droidsonroids/gif/GifDrawable;->h:Lpl/droidsonroids/gif/GifInfoHandle;

    monitor-enter v2

    :try_start_0
    iget-object v3, p2, Lpl/droidsonroids/gif/GifDrawable;->h:Lpl/droidsonroids/gif/GifInfoHandle;
    ...
    invoke-virtual {p2}, Lpl/droidsonroids/gif/GifDrawable;->i()V

    iget-object p4, p2, Lpl/droidsonroids/gif/GifDrawable;->g:Landroid/graphics/Bitmap;
    ...
    iput-object p2, p0, Lpl/droidsonroids/gif/GifDrawable;->g:Landroid/graphics/Bitmap;

    goto :goto_4

    :cond_3
    iput-object p4, p0, Lpl/droidsonroids/gif/GifDrawable;->g:Landroid/graphics/Bitmap;

    :goto_4
    iget-object p2, p0, Lpl/droidsonroids/gif/GifDrawable;->g:Landroid/graphics/Bitmap;
    ...
    iput-object p2, p0, Lpl/droidsonroids/gif/GifDrawable;->p:Landroid/graphics/Rect;
    ...
    iput-object p2, p0, Lpl/droidsonroids/gif/GifDrawable;->n:Lpl/droidsonroids/gif/f;
    ...
    iput p2, p0, Lpl/droidsonroids/gif/GifDrawable;->r:I

    invoke-virtual {p1}, Lpl/droidsonroids/gif/GifInfoHandle;->g()I

    move-result p1

    iput p1, p0, Lpl/droidsonroids/gif/GifDrawable;->s:I
...
.method public final a()V
    ...
    iget-object v0, p0, Lpl/droidsonroids/gif/GifDrawable;->q:Ljava/util/concurrent/ScheduledFuture;
    ...
    :cond_0
    iget-object v0, p0, Lpl/droidsonroids/gif/GifDrawable;->n:Lpl/droidsonroids/gif/f;
...
.method public b()I
    ...
    iget-object v0, p0, Lpl/droidsonroids/gif/GifDrawable;->h:Lpl/droidsonroids/gif/GifInfoHandle;
...
.method public c()I
    ...
    iget-object v1, p0, Lpl/droidsonroids/gif/GifDrawable;->h:Lpl/droidsonroids/gif/GifInfoHandle;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lpl/droidsonroids/gif/GifDrawable;->k:Landroid/graphics/PorterDuffColorFilter;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lpl/droidsonroids/gif/GifDrawable;->f:Landroid/graphics/Paint;
    ...
    iget-object v1, p0, Lpl/droidsonroids/gif/GifDrawable;->k:Landroid/graphics/PorterDuffColorFilter;
    ...
    :goto_0
    iget-object v1, p0, Lpl/droidsonroids/gif/GifDrawable;->g:Landroid/graphics/Bitmap;

    iget-object v2, p0, Lpl/droidsonroids/gif/GifDrawable;->p:Landroid/graphics/Rect;

    iget-object v3, p0, Lpl/droidsonroids/gif/GifDrawable;->d:Landroid/graphics/Rect;

    iget-object v4, p0, Lpl/droidsonroids/gif/GifDrawable;->f:Landroid/graphics/Paint;

    invoke-virtual {p1, v1, v2, v3, v4}, Landroid/graphics/Canvas;->drawBitmap(Landroid/graphics/Bitmap;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Paint;)V

    if-eqz v0, :cond_1

    iget-object p1, p0, Lpl/droidsonroids/gif/GifDrawable;->f:Landroid/graphics/Paint;
...
.method public final g()V
    ...
    iget-boolean v0, p0, Lpl/droidsonroids/gif/GifDrawable;->m:Z
    ...
    iget-object v3, p0, Lpl/droidsonroids/gif/GifDrawable;->o:Lpl/droidsonroids/gif/RenderTask;
    ...
    iput-object v0, p0, Lpl/droidsonroids/gif/GifDrawable;->q:Ljava/util/concurrent/ScheduledFuture;
...
.method public getIntrinsicHeight()I
    ...
    iget v0, p0, Lpl/droidsonroids/gif/GifDrawable;->s:I
...
.method public h(I)V
    ...
    invoke-virtual {v0, p1}, Lpl/droidsonroids/gif/GifInfoHandle;->B(I)V
...
.method public invalidateSelf()V
    ...
    invoke-virtual {p0}, Lpl/droidsonroids/gif/GifDrawable;->g()V
...
.method public isStateful()Z
    ...
    iget-object v0, p0, Lpl/droidsonroids/gif/GifDrawable;->j:Landroid/content/res/ColorStateList;
...
.method public j(J)V
    ...
    iget-object p1, p0, Lpl/droidsonroids/gif/GifDrawable;->n:Lpl/droidsonroids/gif/f;
    ...
    iput-object p1, p0, Lpl/droidsonroids/gif/GifDrawable;->q:Ljava/util/concurrent/ScheduledFuture;
...
.method public onStateChange([I)Z
    ...
    iget-object p1, p0, Lpl/droidsonroids/gif/GifDrawable;->j:Landroid/content/res/ColorStateList;

    if-eqz p1, :cond_0

    iget-object v0, p0, Lpl/droidsonroids/gif/GifDrawable;->l:Landroid/graphics/PorterDuff$Mode;

    if-eqz v0, :cond_0

    invoke-virtual {p0, p1, v0}, Lpl/droidsonroids/gif/GifDrawable;->k(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;

    move-result-object p1

    iput-object p1, p0, Lpl/droidsonroids/gif/GifDrawable;->k:Landroid/graphics/PorterDuffColorFilter;
...
.method public setTintList(Landroid/content/res/ColorStateList;)V
    ...
    iput-object p1, p0, Lpl/droidsonroids/gif/GifDrawable;->j:Landroid/content/res/ColorStateList;
...
.method public setTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iput-object p1, p0, Lpl/droidsonroids/gif/GifDrawable;->l:Landroid/graphics/PorterDuff$Mode;

    iget-object v0, p0, Lpl/droidsonroids/gif/GifDrawable;->j:Landroid/content/res/ColorStateList;

    invoke-virtual {p0, v0, p1}, Lpl/droidsonroids/gif/GifDrawable;->k(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method public setVisible(ZZ)Z
    ...
    iget-boolean v1, p0, Lpl/droidsonroids/gif/GifDrawable;->m:Z
    ...
    invoke-virtual {p0}, Lpl/droidsonroids/gif/GifDrawable;->f()V
...
.method public start()V
    ...
    invoke-virtual {p0, v0, v1}, Lpl/droidsonroids/gif/GifDrawable;->j(J)V
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v2, p0, Lpl/droidsonroids/gif/GifDrawable;->h:Lpl/droidsonroids/gif/GifInfoHandle;
