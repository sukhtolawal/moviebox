...
.method public static i(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {p0, p1}, Lkotlin/collections/q;->a(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static varargs j([Lkotlin/Pair;)Ljava/util/HashMap;
    ...
    invoke-static {v0, p0}, Lkotlin/collections/s;->q(Ljava/util/Map;[Lkotlin/Pair;)V
...
.method public static varargs k([Lkotlin/Pair;)Ljava/util/Map;
    ...
    invoke-static {p0, v0}, Lkotlin/collections/s;->u([Lkotlin/Pair;Ljava/util/Map;)Ljava/util/Map;
...
.method public static final m(Ljava/util/Map;)Ljava/util/Map;
    ...
    :cond_0
    invoke-static {p0}, Lkotlin/collections/r;->g(Ljava/util/Map;)Ljava/util/Map;
...
.method public static r(Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    invoke-static {p0, v1}, Lkotlin/collections/s;->s(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p0, v0}, Lkotlin/collections/s;->s(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;

    move-result-object p0

    invoke-static {p0}, Lkotlin/collections/s;->m(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final s(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p1, p0}, Lkotlin/collections/s;->p(Ljava/util/Map;Ljava/lang/Iterable;)V
...
.method public static t(Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p0}, Lkotlin/collections/MapsKt;->v(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final u([Lkotlin/Pair;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p1, p0}, Lkotlin/collections/s;->q(Ljava/util/Map;[Lkotlin/Pair;)V
