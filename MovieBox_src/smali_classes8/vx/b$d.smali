...
.method public constructor <init>(Lvx/b;Landroidx/room/RoomDatabase;)V
    ...
    iput-object p1, p0, Lvx/b$d;->d:Lvx/b;
...
.method public e()Ljava/lang/String;
    ...
    const-string v0, "UPDATE OR ABORT `st_download_table` SET `id` = ?,`resourceStreamType` = ?,`resourceId` = ?,`lan` = ?,`lanName` = ?,`url` = ?,`size` = ?,`delay` = ?,`downloads` = ?,`type` = ?,`postId` = ?,`subtitleName` = ?,`subjectId` = ?,`ep` = ?,`se` = ?,`resolution` = ?,`subjectName` = ?,`status` = ?,`fileCharsetName` = ?,`path` = ?,`zipPath` = ?,`taskId` = ?,`failCount` = ? WHERE `id` = ? AND `resourceStreamType` = ?"
...
.method public bridge synthetic i(Lg6/k;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lvx/b$d;->l(Lg6/k;Lcom/transsion/subtitle_download/db/SubtitleDownloadTable;)V
